...
if data["VEHICLE TYPE CODE 1"].isna():
    data['CANT_AUTOS'] = 0
elif data["VEHICLE TYPE CODE 2"].isna():
    data['CANT_AUTOS'] = 1
elif data["VEHICLE TYPE CODE 3"].isna():
    data['CANT_AUTOS'] = 2
elif data["VEHICLE TYPE CODE 4"].isna():
    data['CANT_AUTOS'] = 3
elif data["VEHICLE TYPE CODE 5"].isna():
    data['CANT_AUTOS'] = 4
else:
    data['CANT_AUTOS'] = 5
